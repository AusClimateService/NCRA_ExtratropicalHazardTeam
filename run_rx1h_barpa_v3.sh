...
for year in {1979..2020}; do
 ...
 cdo timmax ${dir}/${model}/${ssp}/*/BARPA-R/v1-r1/day/pr/v20231001/pr_AUS-15_${model}_*_day_${year}01-*.nc /scratch/eg3/asp561/NCRA/BARPA/RX1D_BARPA_${model}_${ssp}_${year}.nc
done
...
cdo -b f32 mergetime /scratch/eg3/asp561/NCRA/BARPA/RX1D_BARPA_${model}_${ssp}_????.nc  /scratch/eg3/asp561/NCRA/BARPA/tmp1.nc
cdo mulc,86400 /scratch/eg3/asp561/NCRA/BARPA/tmp1.nc /scratch/eg3/asp561/NCRA/BARPA/tmp2.nc
 cdo -setattribute,pr@units=mm /scratch/eg3/asp561/NCRA/BARPA/tmp2.nc  /scratch/eg3/asp561/NCRA/BARPA/RX1D_BARPA_${model}_${ssp}.nc
rm /scratch/eg3/asp561/NCRA/BARPA/tmp?.nc
